...
-- Poblando ofertas  ACTUALIZADO

INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (1, TO_DATE('2023-01-15', 'YYYY-MM-DD'), 'Calle 123', 'A', 150000, NULL, 'D', 'USR01', 'COD001');

INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (2, TO_DATE('2023-02-10', 'YYYY-MM-DD'), 'Avenida 456', 'C', 200000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V001" Proyecto="No">
            <Escritura>
                <Numero>001</Numero>
                <URL>http://example.com/escritura1.pdf</URL>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL001</Numero>
                <URL>http://example.com/certlib1.jpg</URL>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
), 'N', 'USR02', 'COD002');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (3, TO_DATE('2023-03-05', 'YYYY-MM-DD'), 'Plaza Central', 'B', 250000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V002" Proyecto="Si">
            <Escritura>
                <Numero>002</Numero>
                <URL>http://example.com/escritura2.pdf</URL>
            </Escritura>
        </Anexo>
    </Anexos>'
), 'V', 'USR03', 'COD003');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (5, TO_DATE('2023-05-15', 'YYYY-MM-DD'), 'Avenida Siempre Viva', 'A', 300000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V003" Proyecto="No">
            <Escritura>
                <Numero>003</Numero>
                <URL>http://example.com/escritura3.pdf</URL>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL003</Numero>
                <URL>http://example.com/certlib3.pdf</URL>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
), 'N', 'USR05', 'COD005');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (7, TO_DATE('2023-07-25', 'YYYY-MM-DD'), 'Calle Luna', 'B', 190000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V004" Proyecto="No">
            <Escritura>
                <Numero>004</Numero>
                <URL>http://example.com/escritura4.pdf</URL>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL004</Numero>
                <URL>http://example.com/certlib4.pdf</URL>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
), 'D', 'USR03', 'COD007');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (9, TO_DATE('2023-09-15', 'YYYY-MM-DD'), 'Avenida Libertad', 'A', 175000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V005" Proyecto="Si">
            <Escritura>
                <Numero>005</Numero>
                <URL>http://example.com/escritura5.pdf</URL>
            </Escritura>
        </Anexo>
    </Anexos>'
), 'V', 'USR05', 'COD009');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (10, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 'Calle Victoria', 'C', 230000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V006" Proyecto="No">
            <Escritura>
                <Numero>006</Numero>
                <URL>http://example.com/escritura6.jpg</URL>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL006</Numero>
                <URL>http://example.com/certlib6.pdf</URL>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
), 'D', 'USR10', 'COD010');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (11, TO_DATE('2023-08-01', 'YYYY-MM-DD'), 'Calle Nueva 123', 'A', 200000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V007" Proyecto="No">
            <Escritura>
                <Numero>007</Numero>
                <URL>http://example.com/escritura7.pdf</URL>
                <FechaEmision>2023-02-15</FechaEmision>
                <Autoridad>Notaría 45</Autoridad>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL007</Numero>
                <URL>http://example.com/certlib7.pdf</URL>
                <FechaEmision>2023-03-10</FechaEmision>
                <Autoridad>Oficina de Registro</Autoridad>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
), 'D', 'USR07', 'COD010');
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (12, TO_DATE('2023-09-01', 'YYYY-MM-DD'), 'Avenida Principal 456', 'B', 180000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V008" Proyecto="No">
            <Escritura>
                <Numero>008</Numero>
                <URL>http://example.com/escritura8.pdf</URL>
                <FechaEmision>2023-01-20</FechaEmision>
                <Autoridad>Notaría 32</Autoridad>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL008</Numero>
                <URL>http://example.com/certlib8.pdf</URL>
                <FechaEmision>2024-02-25</FechaEmision>
                <Autoridad>Oficina de Registro</Autoridad>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (13, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 'Plaza Central 789', 'C', 250000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V009" Proyecto="No">
            <Escritura>
                <Numero>009</Numero>
                <URL>http://example.com/escritura9.pdf</URL>
                <FechaEmision>2023-03-15</FechaEmision>
                <Autoridad>Notaría 12</Autoridad>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL009</Numero>
                <URL>http://example.com/certlib9.pdf</URL>
                <FechaEmision>2023-04-10</FechaEmision>
                <Autoridad>Oficina de Registro</Autoridad>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (14, TO_DATE('2023-11-01', 'YYYY-MM-DD'), 'Callejón Largo 321', 'A', 300000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V010" Proyecto="No">
            <Escritura>
                <Numero>010</Numero>
                <URL>http://example.com/escritura10.pdf</URL>
                <FechaEmision>2023-04-10</FechaEmision>
                <Autoridad>Notaría 8</Autoridad>
            </Escritura>
            <CertificadoLibertad>
                <Numero>CL010</Numero>
                <URL>http://example.com/certlib10.pdf</URL>
                <FechaEmision>2023-05-20</FechaEmision>
                <Autoridad>Oficina de Registro</Autoridad>
            </CertificadoLibertad>
        </Anexo>
    </Anexos>'
...
INSERT INTO ofertas (numero, fecha, direccion, tipoVivienda, costo, anexos, estado, idUsuario, codigoUbicacion)
VALUES (15, TO_DATE('2023-12-01', 'YYYY-MM-DD'), 'Calle Secundaria 654', 'F', 220000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V011" Proyecto="Si">
            <Escritura>
                <Numero>011</Numero>
                <URL>http://example.com/escritura11.pdf</URL>
                <FechaEmision>2023-05-01</FechaEmision>
                <Autoridad>Notaría 25</Autoridad>
            </Escritura>
        </Anexo>
    </Anexos>'
), 'N', 'USR11', 'COD010');
...
-- <Consultar ofertas sin certificado de libertad en pdf>

SELECT numero, direccion, tipoVivienda, costo, estado, idUsuario, codigoUbicacion
FROM ofertas
WHERE anexos IS NOT NULL
  AND XMLExists('
    declare namespace x="http://www.w3.org/2001/XMLSchema-instance"; 
    let $cert := /Anexos/Anexo/CertificadoLibertad
    return empty($cert) or not(ends-with($cert/URL, ".pdf"))
  ' PASSING anexos)
UNION
SELECT numero, direccion, tipoVivienda, costo, estado, idUsuario, codigoUbicacion
FROM ofertas
WHERE anexos IS NULL;

-- <Consultar todas las ofertas que tengan una escritura y un certificado de libertad>

SELECT numero, fecha, direccion, tipoVivienda, costo, estado, idUsuario, codigoUbicacion
FROM ofertas
WHERE XMLExists('/Anexos/Anexo[Escritura and CertificadoLibertad]'PASSING anexos);

-- <Consultar todas las ofertas con un certificado de libertad con una fecha de emision de como maximo 1 año de diferencia con la del sistema>

SELECT numero, fecha, direccion, tipoVivienda, costo, estado, idUsuario, codigoUbicacion
FROM ofertas
WHERE XMLExists('/Anexos/Anexo[CertificadoLibertad]' PASSING anexos)
  AND TO_DATE(
        EXTRACTVALUE(anexos, '/Anexos/Anexo/CertificadoLibertad/FechaEmision'),
        'YYYY-MM-DD'
...
INSERT INTO ofertas (direccion, tipoVivienda, costo, anexos, idUsuario, codigoUbicacion)
VALUES ('Avenida 456', 'C', 200000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V009" Proyecto="No">
            <Escritura>
                <Numero>009</Numero>
...
INSERT INTO ofertas (direccion, tipoVivienda, costo, anexos, idUsuario, codigoUbicacion)
VALUES ('Plaza Central', 'B', 250000, XMLTYPE(
    '<Anexos>
        <Anexo ID="V009" Proyecto="No">
            <Escritura>
                <Numero>009</Numero>
...
INSERT INTO ofertas (direccion, tipoVivienda, costo, anexos, idUsuario, codigoUbicacion)
VALUES ('Avenida Siempre Viva', 'A', 300000,XMLTYPE(
    '<Anexos>
        <Anexo ID="V009" Proyecto="No">
            <Escritura>
                <Numero>009</Numero>
...
select * from mbda.data where nombres IS NULL;
...
-------------------------------------------------------------------------------
select * from contactos;
select * from personasNaturales where id = 'LTVQW';
...
CREATE OR REPLACE PACKAGE BODY PC_OFERTAS IS
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al modificar oferta' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al eliminar oferta' || SQLERRM);
...
----------------------------------------------------------------------------------------------------------------------------    
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al añadir fotografias' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al modificar fotografias' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al eliminar fotografias' || SQLERRM);
...
----------------------------------------------------------------------------------------------------------------------------
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al modificar la opcion de credito' || SQLERRM);
    ...
    BEGIN 
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error al eliminar la opcion de credito' || SQLERRM);
...
----------------------------------------------------------------------------------------------------------------------------      
    ...
    BEGIN 
        ...
        WHERE ofertas.costo<1000000 AND ubicaciones.latitud = 200 AND ubicaciones.ciudad = 'Bógota';
        RETURN xResultado;
...
CREATE OR REPLACE PACKAGE PK_USUARIOS
IS 
    PROCEDURE AD_USUARIO(x_id IN VARCHAR, x_fechaRegistro IN TIMESTAMP, x_correoElectronico IN VARCHAR); 
    PROCEDURE MO_USUARIO(x_id IN VARCHAR, x_correoElectronico IN VARCHAR);
    PROCEDURE EL_USUARIO(x_id IN VARCHAR);
    ...
    PROCEDURE MO_origenFONDOS(x_numero IN NUMBER, estaAprobado IN CHAR);
...
CREATE OR REPLACE PACKAGE BODY PK_USUARIOS IS
    ...
    BEGIN 
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20002, 'Error al adicionar oferta' || SQLERRM);
    END AD_OFERTA;
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20003, 'Error al modificar oferta' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20004, 'Error al eliminar oferta' || SQLERRM);
...
----------------------------------------------------------------------------------------------------------------------------    
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20005, 'Error al añadir fotografias' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20006, 'Error al modificar fotografias' || SQLERRM);
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20007, 'Error al eliminar fotografias' || SQLERRM);
...
----------------------------------------------------------------------------------------------------------------------------
    ...
    BEGIN
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20008, 'Error al modificar la opcion de credito' || SQLERRM);
    ...
    BEGIN 
        ...
        EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20009, 'Error al eliminar la opcion de credito' || SQLERRM);
    END EL_OPCIONCREDITO;
...
GRANT EXECUTE ON PK_USUARIOS TO rol_Usuario;
...
BEGIN
    ...
    PK_USUARIOS.AD_USUARIO('us025',SYSDATE, 'daniel@gmail.com');
...
BEGIN
    ...
    PK_USUARIOS.AD_OFERTA('Calle 123', 'A', 150000, NULL, 'us025', 'COD001');
...
BEGIN
    ...
    PK_USUARIOS.MO_OPCIONCREDITO(1,SYSDATE, 12, 100000);
